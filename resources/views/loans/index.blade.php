            ...
            <div class="card-body row align-items-center" >
                <form class="col align-self-center" action="{{ route('loan.register') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="address" class="form-control" id="inputaddress" value="{{ old('address') }}" placeholder="address" >
                            @error('address')
                            <div>
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" name="amount" class="form-control" id="inputamount" value="{{ old('amount') }}" placeholder="amount" >
                            @error('amount')
                            <div>
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="d-flex">
                            <input type="number" name="period" class="form-control" id="inputperiod" value="{{ old('period') }}" placeholder="Periode">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="income" class="form-control" value="{{ old('income') }}" id="inputPasswordConfirmation" placeholder="Revenu mensuel">
                            @error('income')
                            <div>
                                {{ $message }}
                            </div>
